...
read_pairs_ch_adapter = Channel.fromPath(params.adapter)


read_pairs_ch_trim = read_pairs_ch.combine(read_pairs_ch_singleEnd)
read_pairs_ch_final = read_pairs_ch_trim.combine(read_pairs_ch_adapter)
read_pairs_ch_final.view()


trimmomatic(read_pairs_ch_final)
}
